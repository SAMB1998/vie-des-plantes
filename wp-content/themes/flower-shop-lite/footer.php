...
<div id="footer-wrapper">
    <div class="container footer">
        ...
        <!-- Ajout des nouveaux blocs personnalisés -->
        <div class="cols-3 widget-column-4">
            <h5>La Vie des Plantes</h5>
            <p>Bienvenue à La Vie des Plantes, votre boutique de plantes préférée à Paris. Nous offrons une large sélection de plantes et accessoires pour embellir votre maison ou votre jardin.</p>
        </div>
        <div class="cols-3 widget-column-5">
            <h5>Contactez-Nous</h5>
            <p>Numéro de téléphone : 01 28 28 97 13<br>
            Adresse : 84 Boulevard Raspail, 75006 Paris<br>
            Adresse e-mail : <a href="mailto:contact@laviedesplante.fr">contact@laviedesplante.fr</a></p>
        </div>
        <!-- Fin de l'ajout des nouveaux blocs -->
        <div class="clear"></div>
    </div><!--end .container--> 
